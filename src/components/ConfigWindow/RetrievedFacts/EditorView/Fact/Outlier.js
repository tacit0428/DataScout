...
export default class Outlier extends Component {
    componentDidMount() {
        ...
        if (fact.measure.length && fact.breakdown.length) {
            ...
            console.log('outlierindex', outlierIndex)
    ...
    render() {
        ...
        const aggregationType = [],
            ...
            console.log('outlier', fact.focus)
...
//             console.log('outlier', outlierIndex)
