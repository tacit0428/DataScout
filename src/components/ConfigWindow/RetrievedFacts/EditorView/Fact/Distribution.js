...
export default class Distribution extends Component {
    ...
    render() {
        ...
        let modalPosition;
        if (document.getElementById('add-subspace-distribution')) {
            modalPosition = document.getElementById('add-subspace-distribution').getBoundingClientRect()
        }
        ...
        return (
            <div className="config-panel">
                ...
                <Row className={fact.subspace.length === 0 ? 'shelf' : ''}>
                    ...
                    <Col span={16} >
                        <Button id='add-subspace-distribution' ref='addSubBtn' size='small' onClick={showModal}>
                            +
                        </Button>
                    </Col>
                </Row>
